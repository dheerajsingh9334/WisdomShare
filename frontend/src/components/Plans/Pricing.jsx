    ...
    <section className="py-24 bg-black text-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h1 className="text-4xl lg:text-6xl font-bold font-serif text-white mb-6">
            Choose Your Plan
          </h1>
          ...
          <div className="bg-black/50 backdrop-blur-xl border border-white/10 text-white  shadow-lg border border-white/10 border-white/10 p-4 sm:p-6 lg:p-8 relative">
            <div className="text-center">
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center px-4 sm:px-6 py-2 sm:py-3 border border-white/20 border-white/20  text-xs sm:text-sm font-semibold text-gray-300 bg-black/50 backdrop-blur-xl border border-white/10 text-white hover:bg-gray-50 dark:hover:bg-gray-700 transition duration-200"
              >
                Get Started Free
              </button>
            </div>
          ...
          <div className="bg-gradient-to-br from-green-500 to-green-600  shadow-xl p-4 sm:p-6 lg:p-8 relative transform scale-105">
            ...
            <div className="text-center">
              ...
              <div className="mb-4 sm:mb-6">
                ...
                <span className="inline-flex items-center px-2 sm:px-3 py-1 rounded-full bg-black/40 backdrop-blur-md text-white text-green-600 text-xs font-semibold">
                  PREMIUM
                </span>
              </div>
              <button
                ...
                className="w-full inline-flex items-center justify-center px-4 sm:px-6 py-2 sm:py-3 bg-black/40 backdrop-blur-md text-white text-green-600  text-xs sm:text-sm font-semibold hover:bg-gray-50 transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              >
          ...
          <div className="bg-black/50 backdrop-blur-xl border border-white/10 text-white  shadow-lg border border-white/10 border-white/10 p-4 sm:p-6 lg:p-8 relative">
            ...
            <div className="text-center">
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center px-4 sm:px-6 py-2 sm:py-3 bg-indigo-600 text-white  text-xs sm:text-sm font-semibold hover:bg-indigo-700 transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              >
